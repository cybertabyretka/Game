...
from Utils.Settings.Icons.Icons import SWORD_ICON, SHIELD_ICON
...
from Models.Assets.Asset import WeaponsAssets, PlayerAssets
...
swordsman = Swordsman(swordsman_inventory, start_pos=(140, 595), current_weapon=swordsman_sword, current_shield=swordsman_shield)
NPCs = [swordsman]

BASE_ROOMS_MAP = RoomsMap((1, 2))
make_room(BASE_ROOMS_MAP.map, (0, 0), NPCs)
make_room(BASE_ROOMS_MAP.map, (1, 0), [])
doors = [Door(Tile(None, 0, (350, 0), 'front_door', 0),
              Tile(None, 0, (350, 665), 'front_door', 0),
...
BASE_PLAYER = Player(player_inventory, player_windows, start_pos=BASE_PLAYER_START_POS, current_weapon=player_sword, current_shield=player_shield)

...
class Entity:
    def __init__(self, images_asset, width: float, height: float, start_pos, max_velocity, current_weapon, surface, max_health, inventory):
...
class NPC(Entity):
    def __init__(self, images_paths, width: float, height: float, start_pos, max_velocity, current_weapon, surface, max_health, inventory):
        super().__init__(images_paths, width, height, start_pos, max_velocity, current_weapon, surface, max_health, inventory)
...
class Swordsman(NPC):
    def __init__(self, images_paths, surface, inventory, width=35., height=35., start_pos=(0, 0), max_velocity=1, current_weapon=None, max_health=2):
        super().__init__(images_paths, width, height, start_pos, max_velocity, current_weapon, surface, max_health, inventory)